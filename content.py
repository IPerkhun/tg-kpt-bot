...
FINISH_QUIZ_MESSAGE = (
    "*Спасибо за ответы!* Как только ты будешь готов бросить курить, вызови команду /stop_smoking, "
...
RELAPSE_QUIZ_SITUATION_PROMPT = "Чё по месту? Где находился(-ась)? 👀"
RELAPSE_QUIZ_CUSTOM_SITUATION_PROMPT = "Расскажи, где именно тусил(-а):"
RELAPSE_QUIZ_THOUGHTS_PROMPT = "Какие мысли пролетели в голове? 💭"
RELAPSE_QUIZ_CUSTOM_THOUGHTS_PROMPT = "Напиши, что подумал(-а):"
...
RELAPSE_QUIZ_PHYSICAL_PROMPT = "Чё с телом? Какие симптомы? 💪"
RELAPSE_QUIZ_CUSTOM_PHYSICAL_PROMPT = "Опиши свои ощущения:"
RELAPSE_QUIZ_BEHAVIOR_PROMPT = "Что сделал(-а), чтобы не сорваться? 🤔"
RELAPSE_QUIZ_CUSTOM_BEHAVIOR_PROMPT = "Чё конкретно сделал(-а)?"
RELAPSE_QUIZ_FINISH_MESSAGE = "Чётко! Все данные сохранились. 💾"
