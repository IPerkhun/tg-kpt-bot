...
Ты можешь в любой момент *_написать_* боту и он поможет тебе в сложные моменты. Кроме бот может обрабатывать *_твои голосовые сообщения_* и помогать в сложных ситуациях.
